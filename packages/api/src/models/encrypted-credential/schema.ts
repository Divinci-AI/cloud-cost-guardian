...
const encryptedCredentialSchema = new Schema<EncryptedCredentialDocument>({
  ...
  provider: { type: String, required: true, enum: ["cloudflare", "gcp", "aws", "runpod", "redis", "mongodb", "openai", "anthropic", "xai", "replicate", "snowflake", "vercel", "datadog", "neon", "mongodb-atlas", "cloud-sql-postgres"] },
