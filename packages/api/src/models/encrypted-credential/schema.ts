...
const encryptedCredentialSchema = new Schema<EncryptedCredentialDocument>({
  ...
  provider: { type: String, required: true, enum: ["cloudflare", "gcp", "aws", "runpod", "redis", "mongodb", "openai", "anthropic", "xai", "replicate", "snowflake", "vercel", "datadog", "neon", "neo4j", "mongodb-atlas", "cloud-sql-postgres"] },
